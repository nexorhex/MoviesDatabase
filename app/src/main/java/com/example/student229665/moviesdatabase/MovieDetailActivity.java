...
public class MovieDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intentThatStarted.hasExtra("original_title")) {
            ...
            //String backdrop = getIntent().getExtras().getString("backdrop");
        ...
        movies = favoriteDbHelper.getAllFavorite();
        ...
        materialFavoriteButtonNice.setOnFavoriteChangeListener(
                new MaterialFavoriteButton.OnFavoriteChangeListener() {
                    ...
                    public void onFavoriteChanged(MaterialFavoriteButton buttonView, boolean favorite) {
                        if (favorite) {
                            SharedPreferences.Editor editor = getSharedPreferences("com.example.student229665.moviesdatabase.MovieDetailActivity", MODE_PRIVATE).edit();
                            ...
                            String title = nameOfMovie.getText().toString().trim();
                            favoriteDbHelper = new FavoriteDbHelper(MovieDetailActivity.this);
                            favoriteDbHelper.deleteFavorite(title);
                            SharedPreferences.Editor editor = getSharedPreferences("com.example.student229665.moviesdatabase.MovieDetailActivity", MODE_PRIVATE).edit();
    ...
    public void saveFavorite() {
        ...
        favorite.setDescription(synopsis);
